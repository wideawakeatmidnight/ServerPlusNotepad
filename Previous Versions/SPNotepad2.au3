...
Global $FirstName = GUICtrlCreateInput("First", 8, 15, 139, 28, $ES_READONLY)
...
;;ToolTips
GUICtrlSetTip($FirstName, "Ctrl + Shift + S","Shortcut to Paste",1,1)
GUICtrlSetTip($Email, "Ctrl + Shift + D","Shortcut to Paste",1,1)
GUICtrlSetTip($PhoneNumber, "Ctrl + Shift + F","Shortcut to Paste",1,1)
GUICtrlSetTip($AdditionalNotes, "Ctrl + Shift + Q","Shortcut to Paste",1,1)
